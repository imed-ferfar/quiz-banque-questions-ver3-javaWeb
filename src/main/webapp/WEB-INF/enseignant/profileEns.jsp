...
<html lang="fr">
    <head>
        ...
        <!-- Ajout d'une icone au titre de la page-->
        <link rel="icon" href="images/Activité-loisirs-et-culture.png">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9" id="zoneProfil">
                    <div class="card">
                        <h5 class="card-header text-center"><b><fmt:message key="profilEns.titre"/></b> </h5>
                        <div id="profilEns">
                                ...
                                <div class="form-group">
                                    <div class="card-body">
                                        ...
                                        <form action="NouveauCompte" role="form" data-toggle="validator" method="post">
                                            <div class="form-group">
                                                <label><fmt:message key="profilEns.num"/></label>
                                                ...
                                                <div class="form-group">
                                                    <label><fmt:message key="profilEns.nom"/></label>
                                                ...
                                                <div class="form-group">
                                                    <label><fmt:message key="profilEns.prenom"/></label>
                                                    <input type="text" class="form-control" name="prenom" maxlength="25" minlength="3" pattern="^[a-zA-Z]*$"
                                                           id="prenom" placeholder="Pr�nom" value="${sessionScope.perso.prenom}"required>

                                                    <!-- Erreur -->
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label><fmt:message key="profilEns.courriel"/></label>
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-primary btn-block"><fmt:message key="profilEns.btnSubmit"/></button>
                                                </div>
                                            </div>
                                        </form>
                                        ...
                                        <label id="lblModifPwd" class="btn-outline-primary"> <b><fmt:message key="profilEns.titreModifpwd"/></b></label>
                                        <div class="form-group"> </div>
                                        <br>
                                        <div id="zoneModifPwd">
                                            <div class="card">
                                                <h5 class="card-header text-center"><b><fmt:message key="profilEns.titreModifpwd"/></b> </h5>
                                                <form name="formProfilEns" action="PageProfil">
                                                    <div class="form-group">
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                <label ><fmt:message key="profilEns.pwd"/></label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label><fmt:message key="profilEns.pwdNew"/></label>
                                                                    ...
                                                                    <input type="hiden" name="source" id="source" value="modifPasse">

                                                                    <!-- Erreur -->
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label><fmt:message key="profilEns.pwdNewConfirm"/></label>
                                                                ...
                                                                <!-- déclaration du bouton de validation -->
                                                                <div class="form-group">
                                                                    <button id="btnSave" type="submit" class="btn btn-primary btn-block"><fmt:message key="profilEns.btnSave"/></button>
                                                                    <button id="btnCancel" type="reset" class="btn btn-primary btn-block"><fmt:message key="profilEns.btnCancel"/></button>
                                                                </div>
                                                                <br> 
                                                            </div>
                                                            <div class="help-block with-errors"></div>
