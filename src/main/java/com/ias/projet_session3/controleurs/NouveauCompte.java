...
public class NouveauCompte extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String dest = "/acceuil.jsp?source=new";
        
        Personne perso = TraitementsServlets.creerPersonne(request);
        HttpSession session = request.getSession();
        session.setAttribute("perso", perso );
        CompteService.AjouterPersonne(perso);
        /*EntityTransaction tr = EntityManagerSingleton.getEntityManager().getTransaction();
        
        tr.begin();
        EntitiesServiceJpa.AjouterPersonne(perso);
        tr.commit();
